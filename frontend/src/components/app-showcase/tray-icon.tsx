...
export function TrayIcon({
    ...
    return (
        ...
        >
            ...
            <rect x="3" y="3" width="38" height="38" rx="10" fill="currentColor" mask={`url(#${maskId})`}/>
            <rect x="3" y="3" width="38" height="38" rx="10" fill="none" stroke="currentColor" strokeWidth="1.6"/>
