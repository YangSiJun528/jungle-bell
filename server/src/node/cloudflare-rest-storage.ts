...
export interface CloudflareRestStorageDependencies {
  fetch?: Fetch;
  d1: Pick<D1Database, "prepare" | "batch">;
}
...
export class CloudflareRestStorage implements CollectorStorage {
  private readonly d1: Pick<D1Database, "prepare" | "batch">;
  ...
  private async putObject(
    ...
    const requestBody: BodyInit = typeof body === "string" ? body : Uint8Array.from(body).buffer;
