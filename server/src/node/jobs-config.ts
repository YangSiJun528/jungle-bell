...
import type { D1GatewayDatabaseOptions } from "./d1-gateway-database";
import type { CloudflareRestStorageOptions } from "./cloudflare-rest-storage";
import type { NodeWebPushConfiguration } from "./web-push-sender";
...
export interface JobsConfiguration {
  ...
  vapid: NodeWebPushConfiguration;
}
