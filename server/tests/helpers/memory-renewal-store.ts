...
import type { LaundryEvent } from "../../src/collector/types";
import type { PlannedLaundryNotification } from "../../src/domain/laundry-notifications";
import { DESKTOP_ENROLLMENT_POLICY } from "../../src/domain/enrollment-policy";
