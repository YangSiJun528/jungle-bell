import { ATTENDANCE_CLIENT_CLOCK_SKEW_MS, ATTENDANCE_SNAPSHOT_FRESH_MS } from "@jungle-bell/backend-common/renewal/attendance-policy";
import type { AttendanceSnapshotRecord } from "@jungle-bell/backend-common/ports/account-storage";
