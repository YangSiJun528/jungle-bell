import ky from "ky";
import type { BinaryHttpResponse, JsonHttpResponse } from "@jungle-bell/backend-common/collection/types";
...
/** Fetches and bounds an upstream JSON response for collection services. */
